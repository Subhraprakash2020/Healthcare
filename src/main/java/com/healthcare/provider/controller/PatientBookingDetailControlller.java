...
public class PatientBookingDetailControlller {
    ...
    @GetMapping("/count")
    public ResponseEntity<?> getBookedPatientCountForProvider(Principal principal, @RequestParam String date) {
        LocalDate bookingDate = LocalDate.parse(date);
        return ResponseEntity.ok(patientBookingDetailsService.getBookedPatientCountForProvider(principal.getName(),bookingDate));
    }
}
